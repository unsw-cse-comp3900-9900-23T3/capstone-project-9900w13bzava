...
-- 一些初始记录
-- 插入数据
INSERT INTO patients (firstName, surname, medicareNo, email, phoneNumber, sexCode, locationID) VALUES
('John', 'Doe', '12345678', 'john.doe@example.com', '1234567890', 1, 1),
('Jane', 'Smith', NULL, 'jane.smith@example.com', '0987654321', 2, 1),
('Alice', 'Wang', '87654321', NULL, '1122334455', 2, 1),
('Bob', 'Zhang', '23456789', 'bob.zhang@example.com', '2233445566', 1, 1),
