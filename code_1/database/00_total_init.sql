...
INSERT INTO appointments (appointmentDate, duration, startTime, userID, patientID, appointmentTypeID, locationID, appointmentStatusID) VALUES
    ('2023-11-01 09:00:00', 10, '2023-11-01 09:00:00', 1, 2, 2, 1, 2),  -- Zhenwei Wu为Jane Smith安排了一个长时间预约
    ('2023-11-01 09:30:00', 15, '2023-11-01 09:30:00', 2, 3, 3, 1, 3),  -- Haodong Ke为Alice Wang安排了一个短时间预约
    ('2023-11-01 10:00:00', 5, '2023-11-01 10:00:00', 3, 4, 4, 0, 4),   -- Sha Zhou为Bob Zhang安排了一个新患者的预约
    ('2023-11-01 10:30:00', 10, '2023-11-01 10:30:00', 4, 5, 5, 1, 5),  -- Zhetai Jiang为Charlie Liu安排了一个切除预约
    ('2023-11-01 11:00:00', 15, '2023-11-01 11:00:00', 5, 1, 6, 0, 6),  -- Yalin Li为John Doe安排了一个操作预约
    ('2023-11-02 09:00:00', 10, '2023-11-02 09:00:00', 1, 3, 7, 1, 7),  -- Zhenwei Wu为Alice Wang安排了一个免疫预约
    ('2023-11-02 09:45:00', 15, '2023-11-02 09:45:00', 2, 5, 8, 1, 8),  -- Haodong Ke为Charlie Liu安排了一个保险体检预约
    ('2023-11-02 10:15:00', 10, '2023-11-02 10:15:00', 3, 1, 9, 0, 9),  -- Sha Zhou为John Doe安排了一个潜水体检预约
    ('2023-11-02 11:00:00', 5, '2023-11-02 11:00:00', 4, 2, 10, 1, 1),  -- Zhetai Jiang为Jane Smith安排了一个会议
    ('2023-11-02 13:00:00', 10, '2023-11-02 13:00:00', 5, 4, 11, 0, 2)   -- Yalin Li为Bob Zhang安排了一个手术预约
;
