...
INSERT INTO appointments (appointmentDate, duration, startTime, userID, patientID, appointmentTypeID, locationID, appointmentStatusID, note) VALUES
    ('2023-11-01 09:00:00', 10, '2023-11-01 09:00:00', 1, 2, 2, 1, 2, 'zhenwei wu range a appointment for jane smith'),  -- Zhenwei Wu为Jane Smith安排了一个长时间预约
    ...
    ('2023-11-02 09:00:00', 10, '2023-11-02 09:00:00', 1, 3, 7, 1, 7, 'may be xxxx'),  -- Zhenwei Wu为Alice Wang安排了一个免疫预约
